...
/* harmony import */ var _modules_textarea__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/textarea */ "./js/modules/textarea.js");
...
$(window).on('load', function () {
  ...
  Object(_modules_textarea__WEBPACK_IMPORTED_MODULE_4__["textarea"])();
...
/*!**********************************************!*\
  !*** ./js/modules/change-textarea-height.js ***!
  \**********************************************/
/*! exports provided: changeTextareaHeight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeTextareaHeight", function() { return changeTextareaHeight; });
...
var formValidate = function formValidate() {
  var validateForm = $('.basket__form').validate({
    rules: {
      address: {
        required: true
      },
    ...
    submitHandler: function submitHandler(form) {
      var $dataForm = $(".basket__form").serializeArray();
...
/* harmony import */ var _modules_change_textarea_height__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/change-textarea-height */ "./js/modules/change-textarea-height.js");

var textarea = function textarea() {
  $('textarea').on('keyup', function () {
    Object(_modules_change_textarea_height__WEBPACK_IMPORTED_MODULE_0__["changeTextareaHeight"])();
    // $(this).height(0);
    // $(this).height(this.scrollHeight);
